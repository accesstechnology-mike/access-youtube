...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 521: (e) => {
        ...
        var i = { 226: function(i2, o2) {
          !function(a2, s2) {
            ...
            var l = "function", u = "undefined", c = "object", d = "string", p = "major", h = "model", g = "name", f = "type", b = "vendor", v = "version", m = "architecture", _ = "console", w = "mobile", y = "tablet", x = "smarttv", E = "wearable", O = "embedded", S = "Amazon", R = "Apple", C = "ASUS", P = "BlackBerry", T = "Browser", N = "Chrome", I = "Firefox", M = "Google", k = "Huawei", A = "Microsoft", j = "Motorola", L = "Opera", D = "Samsung", q = "Sharp", U = "Sony", B = "Xiaomi", V = "Zebra", $ = "Facebook", G = "Chromium OS", H = "Mac OS", X = function(e2, t2) {
              ...
              var r2 = typeof a2 !== u && a2.navigator ? a2.navigator : s2, n2 = e2 || (r2 && r2.userAgent ? r2.userAgent : ""), i3 = r2 && r2.userAgentData ? r2.userAgentData : s2, o3 = t2 ? X(J, t2) : J, _2 = r2 && r2.userAgent == n2;
              return this.getBrowser = function() {
                var e3, t3 = {};
                return t3[g] = s2, t3[v] = s2, Q.call(t3, n2, o3.browser), t3[p] = typeof (e3 = t3[v]) === d ? e3.replace(/[^\d\.]/g, "").split(".")[0] : s2, _2 && r2 && r2.brave && typeof r2.brave.isBrave == l && (t3[g] = "Brave"), t3;
              }, this.getCPU = function() {
                var e3 = {};
                return e3[m] = s2, Q.call(e3, n2, o3.cpu), e3;
              }, this.getDevice = function() {
                var e3 = {};
                return e3[b] = s2, e3[h] = s2, e3[f] = s2, Q.call(e3, n2, o3.device), _2 && !e3[f] && i3 && i3.mobile && (e3[f] = w), _2 && "Macintosh" == e3[h] && r2 && typeof r2.standalone !== u && r2.maxTouchPoints && r2.maxTouchPoints > 2 && (e3[h] = "iPad", e3[f] = y), e3;
              }, this.getEngine = function() {
                var e3 = {};
                return e3[g] = s2, e3[v] = s2, Q.call(e3, n2, o3.engine), e3;
              }, this.getOS = function() {
                var e3 = {};
                return e3[g] = s2, e3[v] = s2, Q.call(e3, n2, o3.os), _2 && !e3[g] && i3 && "Unknown" != i3.platform && (e3[g] = i3.platform.replace(/chrome os/i, G).replace(/macos/i, H)), e3;
      ...
      let i = r(738), o = { url: (e2) => e2.url, header: (e2, t2) => e2.headers.get(t2) };
      ...
      async function s(e2, t2) {
        ...
        if (!c.ok) throw Object.defineProperty(Error(`Proxy request failed: ${c.status}`), "__NEXT_ERROR_CODE", { value: "E146", enumerable: false });
        ...
        switch (p) {
          ...
          case "abort":
          case "unhandled":
            throw Object.defineProperty(Error(`Proxy request aborted [${t2.method} ${t2.url}]`), "__NEXT_ERROR_CODE", { value: "E145", enumerable: false });
        }
        return function(e3) {
      ...
      r.r(i), r.d(i, { config: () => e9, middleware: () => e4 });
      let a = null;
      async function s() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
      ...
      process !== r.g.process && (process.env = r.g.process.env, r.g.process = process), Object.defineProperty(globalThis, "__import_unsupported", { value: function(e10) {
        let t2 = new Proxy(function() {
          ...
          if ("then" === r2) return {};
          throw Object.defineProperty(Error(d(e10)), "__NEXT_ERROR_CODE", { value: "E394", enumerable: false });
        }, construct() {
          throw Object.defineProperty(Error(d(e10)), "__NEXT_ERROR_CODE", { value: "E394", enumerable: false });
        }, apply(r2, n2, i2) {
  ...
  `);
      ...
      function m(e10) {
        try {
          ...
          throw Object.defineProperty(Error(`URL is malformed "${String(e10)}". Please use only absolute URLs - https://nextjs.org/docs/messages/middleware-relative-urls`, { cause: t2 }), "__NEXT_ERROR_CODE", { value: "E61", enumerable: false });
        }
      }
      ...
      class E extends x {
        ...
        get request() {
          throw Object.defineProperty(new p({ page: this.sourcePage }), "__NEXT_ERROR_CODE", { value: "E394", enumerable: false });
        }
        respondWith() {
          throw Object.defineProperty(new p({ page: this.sourcePage }), "__NEXT_ERROR_CODE", { value: "E394", enumerable: false });
        }
      ...
      class A {
        ...
        set locale(e10) {
          var t2, r2;
          if (!this[k].locale || !(null == (r2 = this[k].options.nextConfig) ? void 0 : null == (t2 = r2.i18n) ? void 0 : t2.locales.includes(e10))) throw Object.defineProperty(TypeError(`The NextURL configuration includes no locale "${e10}"`), "__NEXT_ERROR_CODE", { value: "E597", enumerable: false });
          this[k].locale = e10;
        }
        get defaultLocale() {
      ...
      function V(e10, t2) {
        ...
        if (null == e10 ? void 0 : null == (r2 = e10.request) ? void 0 : r2.headers) {
          if (!(e10.request.headers instanceof Headers)) throw Object.defineProperty(Error("request.headers must be an instance of Headers"), "__NEXT_ERROR_CODE", { value: "E119", enumerable: false });
          let r3 = [];
      ...
      class $ extends Response {
        ...
        static redirect(e10, t2) {
          ...
          if (!B.has(r2)) throw Object.defineProperty(RangeError('Failed to execute "redirect" on "response": Invalid status code'), "__NEXT_ERROR_CODE", { value: "E529", enumerable: false });
      ...
      let H = "Next-Router-Prefetch", X = ["RSC", "Next-Router-State-Tree", H, "Next-HMR-Refresh", "Next-Router-Segment-Prefetch"];
      ...
      class W extends Headers {
        ...
        static from(e10) {
          return e10 instanceof Headers ? e10 : new W(e10);
        }
        append(e10, t2) {
      ...
      let F = Object.defineProperty(Error("Invariant: AsyncLocalStorage accessed in runtime where it is not available"), "__NEXT_ERROR_CODE", { value: "E504", enumerable: false });
      class K {
        disable() {
          throw F;
        }
      ...
      function ei(e10) {
        if ("action" !== function(e11) {
          ...
          if (t2) {
            ...
            if ("prerender" === t2.type || "prerender-ppr" === t2.type || "prerender-legacy" === t2.type) throw Object.defineProperty(Error(`\`${e11}\` cannot be called inside a prerender. This is a bug in Next.js.`), "__NEXT_ERROR_CODE", { value: "E401", enumerable: false });
            if ("cache" === t2.type) throw Object.defineProperty(Error(`\`${e11}\` cannot be called inside "use cache". Call it outside and pass an argument instead. Read more: https://nextjs.org/docs/messages/next-request-in-use-cache`), "__NEXT_ERROR_CODE", { value: "E37", enumerable: false });
            if ("unstable-cache" === t2.type) throw Object.defineProperty(Error(`\`${e11}\` cannot be called inside unstable_cache. Call it outside and pass an argument instead. Read more: https://nextjs.org/docs/app/api-reference/functions/unstable_cache`), "__NEXT_ERROR_CODE", { value: "E69", enumerable: false });
          }
          throw Object.defineProperty(Error(`\`${e11}\` was called outside a request scope. Read more: https://nextjs.org/docs/messages/next-dynamic-api-wrong-context`), "__NEXT_ERROR_CODE", { value: "E251", enumerable: false });
        }(e10).phase) throw new ee();
      }
      var eo = function(e10) {
      ...
      let { context: ew, propagation: ey, trace: ex, SpanStatusCode: eE, SpanKind: eO, ROOT_CONTEXT: eS } = n = r(243);
      ...
      let eC = (e10, t2) => {
        ...
        })(t2) && t2.bubble ? e10.setAttribute("next.bubble", true) : (t2 && e10.recordException(t2), e10.setStatus({ code: eE.ERROR, message: null == t2 ? void 0 : t2.message })), e10.end();
      }, eP = /* @__PURE__ */ new Map(), eT = n.createContextKey("next.rootSpanId"), eN = 0, eI = () => eN++, eM = { set(e10, t2, r2) {
      ...
      class ek {
        ...
        getTracePropagationData() {
          let e10 = ew.active(), t2 = [];
          return ey.inject(e10, t2, eM), t2;
        }
        getActiveScopeSpan() {
        ...
        withPropagatedContext(e10, t2, r2) {
          let n2 = ew.active();
          if (ex.getSpanContext(n2)) return t2();
          let i2 = ey.extract(n2, e10, r2);
          return ew.with(i2, t2);
        }
        trace(...e10) {
          var t2;
          ...
          l2 ? (null == (t2 = ex.getSpanContext(l2)) ? void 0 : t2.isRemote) && (u2 = true) : (l2 = (null == ew ? void 0 : ew.active()) ?? eS, u2 = true);
          let c2 = eI();
          return a2.attributes = { "next.span_name": s2, "next.span_type": r2, ...a2.attributes }, ew.with(l2.setValue(eT, c2), () => this.getTracerInstance().startActiveSpan(s2, a2, (e11) => {
            let t3 = "performance" in globalThis && "measure" in performance ? globalThis.performance.now() : void 0, n3 = () => {
              eP.delete(c2), t3 && process.env.NEXT_OTEL_PERFORMANCE_PREFIX && em.includes(r2 || "") && performance.measure(`${process.env.NEXT_OTEL_PERFORMANCE_PREFIX}:next-${(r2.split(".").pop() || "").replace(/[A-Z]/g, (e12) => "-" + e12.toLowerCase())}`, { start: t3, end: performance.now() });
            };
            u2 && eP.set(c2, new Map(Object.entries(a2.attributes ?? {})));
            try {
              if (o2.length > 1) return o2(e11, (t5) => eC(e11, t5));
              let t4 = o2(e11);
        ...
        wrap(...e10) {
          ...
          return ev.includes(r2) || "1" === process.env.NEXT_OTEL_VERBOSE ? function() {
            ...
            {
              let n3 = t2.getContext().bind(ew.active(), a2);
        ...
        getRootSpanAttributes() {
          let e10 = ew.active().getValue(eT);
          return eP.get(e10);
        }
        setRootSpanAttribute(e10, t2) {
          let r2 = ew.active().getValue(eT), n2 = eP.get(r2);
          n2 && n2.set(e10, t2);
        }
      }
      let eA = (() => {
      ...
      class eL {
        ...
        enable() {
          if (!this._previewModeId) throw Object.defineProperty(Error("Invariant: previewProps missing previewModeId this should never happen"), "__NEXT_ERROR_CODE", { value: "E93", enumerable: false });
      ...
      async function eG(e10, { revalidatedTags: t2, pendingRevalidates: r2, pendingRevalidateWrites: n2 }) {
        var i2;
        return Promise.all([null == (i2 = e10.incrementalCache) ? void 0 : i2.revalidateTag(t2), ...Object.values(r2), ...n2]);
      }
      let eH = Object.defineProperty(Error("Invariant: AsyncLocalStorage accessed in runtime where it is not available"), "__NEXT_ERROR_CODE", { value: "E504", enumerable: false });
      class eX {
        disable() {
          throw eH;
        }
      ...
      let ez = "undefined" != typeof globalThis && globalThis.AsyncLocalStorage, eW = ez ? new ez() : new eX();
      class eF {
        constructor({ waitUntil: e10, onClose: t2, onTaskError: r2 }) {
          this.workUnitStores = /* @__PURE__ */ new Set(), this.waitUntil = e10, this.onClose = t2, this.onTaskError = r2, this.callbackQueue = new (eU())(), this.callbackQueue.pause();
        }
        after(e10) {
          if (e_(e10)) this.waitUntil || eK(), this.waitUntil(e10.catch((e11) => this.reportTaskError("promise", e11)));
          else if ("function" == typeof e10) this.addCallback(e10);
          else throw Object.defineProperty(Error("`after()`: Argument must be a promise or a function"), "__NEXT_ERROR_CODE", { value: "E50", enumerable: false });
        }
        addCallback(e10) {
          var t2;
          this.waitUntil || eK();
          ...
          let n2 = eW.getStore(), i2 = n2 ? n2.rootTaskSpawnPhase : null == r2 ? void 0 : r2.phase;
          this.runCallbacksOnClosePromise || (this.runCallbacksOnClosePromise = this.runCallbacksOnClose(), this.waitUntil(this.runCallbacksOnClosePromise));
          let o2 = (t2 = async () => {
            try {
              await eW.run({ rootTaskSpawnPhase: i2 }, () => e10());
            } catch (e11) {
              this.reportTaskError("function", e11);
            }
          }, ez ? ez.bind(t2) : eX.bind(t2));
        ...
        async runCallbacks() {
          ...
          let e10 = Y.getStore();
          if (!e10) throw Object.defineProperty(new eB("Missing workStore in AfterContext.runCallbacks"), "__NEXT_ERROR_CODE", { value: "E547", enumerable: false });
        ...
        reportTaskError(e10, t2) {
          if (console.error("promise" === e10 ? "A promise passed to `after()` rejected:" : "An error occurred in a function passed to `after()`:", t2), this.onTaskError) try {
            ...
            console.error(Object.defineProperty(new eB("`onTaskError` threw while handling an error thrown from an `after` task", { cause: e11 }), "__NEXT_ERROR_CODE", { value: "E569", enumerable: false }));
          }
        }
      }
      function eK() {
        throw Object.defineProperty(Error("`after()` will not work correctly, because `waitUntil` is not available in the current environment."), "__NEXT_ERROR_CODE", { value: "E91", enumerable: false });
      }
      class eQ {
        onClose(e10) {
          if (this.isClosed) throw Object.defineProperty(Error("Cannot subscribe to a closed CloseController"), "__NEXT_ERROR_CODE", { value: "E365", enumerable: false });
          this.target.addEventListener("close", e10), this.listeners++;
        }
        dispatchClose() {
          if (this.isClosed) throw Object.defineProperty(Error("Cannot close a CloseController multiple times"), "__NEXT_ERROR_CODE", { value: "E229", enumerable: false });
      ...
      let eY = Symbol.for("@next/request-context");
      class eJ extends D {
        constructor(e10) {
      ...
      let e0 = { keys: (e10) => Array.from(e10.keys()), get: (e10, t2) => e10.get(t2) ?? void 0 }, e1 = (e10, t2) => eA().withPropagatedContext(e10.headers, t2, e0), e2 = false;
      async function e3(e10) {
        var t2;
        let n2, i2;
        !function() {
          if (!e2 && (e2 = true, "true" === process.env.NEXT_PRIVATE_TEST_PROXY)) {
            let { interceptTestApis: e11, wrapRequestHandler: t3 } = r(434);
            e11(), e1 = t3(e1);
          }
        }(), await c();
        ...
        let h2 = new eJ({ page: e10.page, input: function(e11) {
          let t3 = "string" == typeof e11, r2 = t3 ? new URL(e11) : e11;
          return r2.searchParams.delete("_rsc"), t3 ? r2.toString() : r2;
        ...
        if ((n2 = await e1(h2, () => {
          if ("/middleware" === e10.page || "/src/middleware" === e10.page) {
            let t3 = f2.waitUntil.bind(f2), r2 = new eQ();
            return eA().trace(eb.execute, { spanName: `middleware ${h2.method} ${h2.nextUrl.pathname}`, attributes: { "http.target": h2.nextUrl.pathname, "http.method": h2.method } }, async () => {
              try {
                var n3, o3, a3, l3, u3, c2, d3;
                let p3 = eZ(), g3 = (u3 = h2.nextUrl, c2 = void 0, d3 = (e11) => {
                  i2 = e11;
                  ...
                  return { type: "request", phase: e11, implicitTags: i3 ?? [], url: { pathname: n4.pathname, search: n4.search ?? "" }, get headers() {
                    ...
                    if (!d4.cookies) {
                      let e12 = new j.RequestCookies(W.from(t4.headers));
                      eD(t4, e12), d4.cookies = et.seal(e12);
                    }
                    return d4.cookies;
                  }, set cookies(value) {
                    d4.cookies = value;
                    ...
                    if (!d4.mutableCookies) {
                      let e12 = function(e13, t5) {
                        let r4 = new j.RequestCookies(W.from(e13));
                        return en.wrap(r4, t5);
                      ...
                      let e12 = function(e13) {
                        let t5 = new Proxy(e13, { get(e14, r4, n5) {
                          switch (r4) {
                            case "delete":
                              return function(...r5) {
                                return ei("cookies().delete"), e14.delete(...r5), t5;
                              };
                            case "set":
                              return function(...r5) {
                                return ei("cookies().set"), e14.set(...r5), t5;
                              };
                            default:
                    ...
                    return d4.draftMode || (d4.draftMode = new eL(s3, t4, this.cookies, this.mutableCookies)), d4.draftMode;
                  }, renderResumeDataCache: a4 ?? null, isHmrRefresh: l4, serverComponentsHmrCache: u4 || globalThis.__serverComponentsHmrCache };
                }("action", h2, void 0, u3, c2, d3, void 0, p3, false, void 0)), b3 = function({ page: e11, fallbackRouteParams: t4, renderOpts: r3, requestEndedState: n4, isPrefetchRequest: i3, buildId: o4 }) {
                  var a4;
                  let s3 = { isStaticGeneration: !r3.supportsDynamicResponse && !r3.isDraftMode && !r3.isServerAction, page: e11, fallbackRouteParams: t4, route: (a4 = e11.split("/").reduce((e12, t5, r4, n5) => t5 ? "(" === t5[0] && t5.endsWith(")") || "@" === t5[0] || ("page" === t5 || "route" === t5) && r4 === n5.length - 1 ? e12 : e12 + "/" + t5 : e12, "")).startsWith("/") ? a4 : "/" + a4, incrementalCache: r3.incrementalCache || globalThis.__incrementalCache, cacheLifeProfiles: r3.cacheLifeProfiles, isRevalidate: r3.isRevalidate, isPrerendering: r3.nextExport, fetchCache: r3.fetchCache, isOnDemandRevalidate: r3.isOnDemandRevalidate, isDraftMode: r3.isDraftMode, rootParams: {}, requestEndedState: n4, isPrefetchRequest: i3, buildId: o4, reactLoadableManifest: (null == r3 ? void 0 : r3.reactLoadableManifest) || {}, assetPrefix: (null == r3 ? void 0 : r3.assetPrefix) || "", afterContext: function(e12) {
                    let { waitUntil: t5, onClose: r4, onAfterTaskError: n5 } = e12;
                    return new eF({ waitUntil: t5, onClose: r4, onTaskError: n5 });
                  }(r3) };
                ...
                return await Y.run(b3, () => J.run(g3, e10.handler, h2, f2));
              } finally {
                setTimeout(() => {
                  r2.dispatchClose();
                }, 0);
        ...
        })) && !(n2 instanceof Response)) throw Object.defineProperty(TypeError("Expected an instance of Response to be returned"), "__NEXT_ERROR_CODE", { value: "E567", enumerable: false });
      ...
      r(487), "undefined" == typeof URLPattern || URLPattern, r(504).unstable_postpone;
      ...
      }("Route %%% needs to bail out of prerendering at this point because it used ^^^. React throws this special object to indicate where. It should not be caught by your own try/catch. Learn more: https://nextjs.org/docs/messages/ppr-caught-error")) throw Object.defineProperty(Error("Invariant: isDynamicPostpone misidentified a postpone reason. This is a bug in Next.js"), "__NEXT_ERROR_CODE", { value: "E296", enumerable: false });
      async function e4(e10) {
        let t2 = e10.nextUrl.pathname, r2 = e10.headers.get("user-agent") || "", n2 = e10.headers.get("referer") || "";
        if ("/" === t2) {
          let e11 = $.next();
          return e11.headers.set("Clear-Site-Data", '"cache"'), e11.headers.set("Cache-Control", "no-store, no-cache, must-revalidate, proxy-revalidate"), e11;
        }
        let i2 = /bot|crawler|spider|scrapy|wget|curl|facebookexternalhit|twitterbot|linkedinbot|slackbot|whatsapp|telegram|discordbot|googlebot|bingbot|yandex|baidu/i.test(r2), o2 = n2.includes("accessyoutube.org.uk") && 1 === t2.split("/").filter(Boolean).length && r2.endsWith("."), a2 = t2.split("/").filter(Boolean), s2 = 1 === a2.length, l2 = [/\/api\//, /\/play\//, /^\/_next\//, /\/favicon/, /\.(ico|webmanifest)$/, /^\/$/].some((e11) => e11.test(t2));
        if (!s2 || l2) return $.next();
        if (i2 || o2) return console.log(`[Middleware] Blocked ${i2 ? "bot" : "suspicious behavior"} from search page:`, { pathname: t2, userAgent: r2.substring(0, 100), referer: n2.substring(0, 100), reason: i2 ? "bot pattern" : "self-referer with truncated UA" }), $.redirect(new URL("/", e10.url), 307);
        try {
          let r3 = a2[0].replace(/%20/g, "+"), n3 = await fetch(`${e10.nextUrl.origin}/api/check-bad-words?term=${r3}`);
          if (n3.ok) {
            let { hasBadWords: i3 } = await n3.json();
            if (i3) return $.redirect(new URL("/", e10.url), 307);
            if (t2.includes("%20")) {
              let t3 = new URL(e10.url);
              return t3.pathname = `/${r3}`, $.redirect(t3, 307);
            }
          }
          return $.next();
        } catch (t3) {
          return $.redirect(new URL("/", e10.url), 307);
        }
      }
      RegExp(`\\n\\s+at __next_metadata_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_viewport_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_outlet_boundary__[\\n\\s]`), /* @__PURE__ */ new WeakMap();
      let e9 = { matcher: "/:path*" };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let e6 = { ...i }, e5 = e6.middleware || e6.default, e7 = "/middleware";
      if ("function" != typeof e5) throw Object.defineProperty(Error(`The Middleware "${e7}" must export a \`middleware\` or a \`default\` function`), "__NEXT_ERROR_CODE", { value: "E120", enumerable: false });
      function e8(e10) {
        return e3({ ...e10, page: e7, handler: async (...e11) => {
          try {
            return await e5(...e11);
          } catch (i2) {
