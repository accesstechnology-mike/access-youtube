 ...
 */ function getActionModIdOrError(actionId, serverModuleMap) {
    try {
        ...
        throw Object.defineProperty(new Error(`Failed to find Server Action "${actionId}". This request might be from an older or newer deployment. ${err instanceof Error ? `Original error: ${err.message}` : ''}`), "__NEXT_ERROR_CODE", {
            value: "E264",
            enumerable: false
        });
    }
