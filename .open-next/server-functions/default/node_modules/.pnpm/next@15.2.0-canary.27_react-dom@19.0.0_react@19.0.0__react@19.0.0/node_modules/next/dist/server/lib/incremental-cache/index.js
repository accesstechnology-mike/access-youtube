...
class IncrementalCache {
    ...
    async revalidateTag(tags) {
        ...
        return Promise.all([
            ...
            Object.values(_globalThis.__nextCacheHandlers || {}).map((cacheHandler)=>typeof cacheHandler.expireTags === 'function' && cacheHandler.expireTags(...Array.isArray(tags) ? tags : [
                    tags
                ])),
            (_this_cacheHandler = this.cacheHandler) == null ? void 0 : (_this_cacheHandler_revalidateTag = _this_cacheHandler.revalidateTag) == null ? void 0 : _this_cacheHandler_revalidateTag.call(_this_cacheHandler, tags)
        ]).then(()=>{});
    }
