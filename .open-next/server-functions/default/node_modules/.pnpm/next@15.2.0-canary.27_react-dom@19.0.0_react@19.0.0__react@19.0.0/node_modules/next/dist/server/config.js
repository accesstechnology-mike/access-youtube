...
function assignDefaults(dir, userConfig, silent) {
    ...
    if ((_result_devIndicators = result.devIndicators) == null ? void 0 : _result_devIndicators.buildActivityPosition) {
        ...
        if (!allowedValues.includes(buildActivityPosition)) {
            throw Object.defineProperty(new Error(`Invalid "devIndicator.buildActivityPosition" provided, expected one of ${allowedValues.join(', ')}, received ${buildActivityPosition}`), "__NEXT_ERROR_CODE", {
                value: "E51",
                enumerable: false
            });
        }
    ...
    if (!result.experimental.htmlLimitedBots) {
        ...
        result.experimental.htmlLimitedBots = _isbot.HTML_LIMITED_BOT_UA_RE_STRING;
    }
...
async function loadConfig(phase, dir, { customConfig, rawConfig, silent = true, onLoadUserConfig, reactProductionProfiling } = {}) {
    ...
    if (path == null ? void 0 : path.length) {
        ...
        if (((_userConfig_experimental3 = userConfig.experimental) == null ? void 0 : _userConfig_experimental3.htmlLimitedBots) instanceof RegExp) {
            userConfig.experimental.htmlLimitedBots = userConfig.experimental.htmlLimitedBots.source;
        }
