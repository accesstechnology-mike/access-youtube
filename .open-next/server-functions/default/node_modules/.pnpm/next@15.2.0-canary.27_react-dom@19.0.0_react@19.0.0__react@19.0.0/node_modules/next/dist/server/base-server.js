        ...
        try {
            ...
            if (_globalThis.__nextCacheHandlers) {
                ...
                for (const handler of Object.values(_globalThis.__nextCacheHandlers)){
                    if (typeof (handler == null ? void 0 : handler.receiveExpiredTags) === 'function') {
   ...
   */ async prepare() {
    ...
    async pipeImpl(fn, partialContext) {
        ...
        const ctx = {
            ...
            renderOpts: {
                ...
                serveStreamingMetadata: (0, _streamingmetadata.shouldServeStreamingMetadata)(ua, this.renderOpts.experimental)
            }
        };
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && (0, _checks.isAppPageRouteModule)(routeModule);
            ...
            if (routeModule) {
                if ((0, _checks.isAppRouteRouteModule)(routeModule)) {
                    ...
                    if ((0, _checks.isPagesRouteModule)(routeModule)) {
                        ...
                        if (this.nextConfig.experimental.useCache && this.renderOpts.dev && !isPrefetchRSCRequest && !isServerAction) {
        ...
        if (isRoutePPREnabled && typeof segmentPrefetchHeader === 'string') {
            ...
            if (// This is always true at runtime but is needed to refine the type
            // of cacheEntry.value to CachedAppPageValue, because the outer
            // ResponseCacheEntry is not a discriminated union.
            (cachedData == null ? void 0 : cachedData.kind) === _responsecache.CachedRouteKind.APP_PAGE && cachedData.segmentData) {
        ...
        if ((cachedData == null ? void 0 : cachedData.kind) === _responsecache.CachedRouteKind.IMAGE) {
            throw Object.defineProperty(new Error('invariant SSG should not return an image cache value'), "__NEXT_ERROR_CODE", {
                value: "E390",
                enumerable: false
            });
        }
        ...
        if (minimalPostponed) {
            ...
            if (isPreviewMode) {
                ...
                if (cacheEntry.revalidate < 1) {
                    throw Object.defineProperty(new Error(`Invalid revalidate configuration provided: ${cacheEntry.revalidate} < 1`), "__NEXT_ERROR_CODE", {
                        value: "E22",
                        enumerable: false
                    });
                }
